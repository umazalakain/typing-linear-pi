...
\begin{abstract}
  \todo{OD: the abstract requires an opening. Before diving into what we present, it is useful to give context of what the problem is and why it is important.}
  ...
  \todo{OD: remove links and put them as reference under @misc}
\end{abstract}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction}
\todo{OD:
It is important to emphasise that this is the first fully formalised pi-calculus from syntax to OS to typing rules, spanning from linear to shared types, "gradually".}

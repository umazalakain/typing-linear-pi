...
\begin{nidefinition}
  Our usage algebra is a ternary relation $\op{x}{y}{z}$ that is \emph{partial}, \emph{functional}, \emph{cancelative}, \emph{associative}, and \emph{commutative}.
...
\begin{nitheorem}
  ...
  Increment every variable reference greater than or equal to $i$ in process $P$.
...
\begin{nitheorem}
  ...
  Let $P$ be a process where the most recent variable has all its $m$ multiplicities exhausted, such that $\types{\gamma \comma t}{\Gamma \comma m}{P}{\Psi \comma \lz}$.

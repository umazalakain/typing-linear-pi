...
\newcommand{\zero}[0]{\constr{0}}
\newcommand{\one}[0]{\constr{1}}
\newcommand{\plus}[0]{\constr{+}}
\newcommand{\minus}[0]{\constr{-}}
...
\begin{aligned}
  ...
  &\constr{\cdot-join}      &:{} &                      &     & \exists \one . \; \op{\one}{\plus}{\minus} \\
  ...
  &\constr{\cdot-id^l}      &:{} &\forall x             & \to & \op{x}{\zero}{x} \\

...
\begin{proof}[Proof (Sketch)]
  ...
  \begin{itemize}
    ...
    \item
      ...
      we use swapping (\autoref{thm:swapping}), and for the reverse direction swapping and \autoref{lm:swap-swap} to show that swapping two elements in $P$ twice leaves $P$ unchanged.
  \end{itemize}
\end{proof}

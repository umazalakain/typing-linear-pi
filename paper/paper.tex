...
\begin{proof}[Proof (Sketch)]
  ...
  \begin{itemize}
    ...
    \item
      ...
      we use swapping (\autoref{thm:swapping}) (and \autoref{lm:swap-swap} for the reverse direction) to show that swapping two elements in $P$ twice leaves $P$ unchanged.
  \end{itemize}
\end{proof}
\todo{remove the space between the itemize and the qed at the end}
\subsection{Substitution}
\label{substitution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo{generaliz* to generalis* everywhere}

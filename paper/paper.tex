...
We keep typing contexts and usage contexts separate.
...
\begin{nidefinition}
  ...
  This is for convenience, so that there is less universe polymorphism poluting specifications.
...
\begin{nidefinition}
  ...
  Refer to \autoref{fig:indexed-multiplicities} in \autoref{app:indexed-set-usage-algebra} for a formal definition.
\end{nidefinition}
...
\begin{itemize}
  ...
  \item
    ...
    Such a proof could be obtained through automated search --- but it is better yet not to need it.

...
\begin{nidefinition}
  ...
  \todo{comment on synonyms $\ell_i$ etc}
  ...
  Finally, parallel composition is only concerned with usage contexts.
  The leftovers of the left-hand process are used to type the right-hand process.

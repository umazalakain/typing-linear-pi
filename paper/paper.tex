...
\begin{example}[Variable reference]
  ...
  The constructor $\constr{0}$ asserts that the next variable is of type $\channel{\unit}{\li}$, and that the usage annotation $\lio$ can be split such that $\op{\lio}{\li}{\lo}$ --- $\func{\cdot-compute^r}$ automatically fulfills this proof obligation.
  \begin{flalign*}

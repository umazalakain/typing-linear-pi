...
Universe levels and universe polymorphism are omitted for brevity --- all our types are of type $et$.
...
Figure \ref{fig:struct-cong-base} lists the base cases.
...
As such, rewrites can happen anywhere inside a process, and are closed under reflexivity, symmetry and transitivity as shown by the first row of Figure \ref{fig:struct-cong}.
...
\end{mathpar}
\caption{Structural congruence under contexts.}
...
\autoref{fig:reduction} models the operational semantics of the \picalc{}.
  ...
  \begin{mathpar}
    ...
    \datatype{
      ...
      \stacked{
        ...
        y : \Carrier_{idx}^2} \\
      \Delta : \Ctx_{idxs}}
    {\contains{\gamma}{\Gamma}{i}{t}{y}{\Delta} : et}
    \; \textsc{VarRef}

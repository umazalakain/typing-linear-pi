...
\begin{nitheorem}[Strengthening]
  ...
  Then lowering every variable greater than or equal to $i$ in $P$ is well-typed in $\types{\func{delete}_i \; \gamma}{\func{delete}_i \; \Gamma}{\func{lower}_i \; P}{\func{delete}_i \; \Xi}$.
\end{nitheorem}

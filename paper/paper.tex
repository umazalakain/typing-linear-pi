...
\begin{anonsuppress}
In her master's thesis, Zalakain uses a HOAS to embed a session-typed \picalc{} in Coq \cite{Zalakain2019}.
Channel type polymorphism (preventing channels from being constructed out of thin air) and a process-traversing predicate ensure that channels are used linearly --- subject reduction is then shown to preserve this predicate.
\end{anonsuppress}
...
Our work is fully mechanised in around 1850 lines of code in Agda%
\begin{anonsuppress}
\cite{Zalakain2020Agda}
\end{anonsuppress}
.

...
\autoref{fig:struct-cong-base} lists the base cases of structural congruence.
...
As such, rewrites can happen anywhere inside a process, and are closed under reflexivity, symmetry and transitivity as shown in \autoref{fig:struct-cong}.
In  \autoref{subject-congruence} we prove that if two processes $P$ and $Q$ are structurally congruent and $P$ is well-typed, then so is $Q$.

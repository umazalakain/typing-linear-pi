...
Each roles \sender{}, \receiver{} and \courier{} is defined as a function respectively, $\func{send}, \func{recv}$ and $\func{carry}$ with signature $\Var_n \to \Process_n$.

The \sender{} \emph{role} is defined below.
The \sender{} creates a new channel $\new{} \suc c$ denoting the data to be sent, and sends it over channel $c$, and then terminates, denoted by process $\PO$.
\begin{flalign*}

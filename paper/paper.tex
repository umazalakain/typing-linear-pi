...
\item \textbf{Formalisation of the syntax and the semantics of the \picalc{}}:
 ...
 \end{itemize}
  ...
  \begin{itemize}
    ...
    Leftover typing renders top-down context splits unnecessary, allows for a \emph{framing} (\autoref{thm:framing}) theorem to be stated, and makes it possible to generalise the \emph{weakening} (\autoref{thm:weakening}) and \emph{strengthening} (\autoref{thm:strengthening}) theorems.
  \end{itemize}

...
In Figure \ref{fig:multiplicities} we present an algebra $\Quantifier_C$ on the carrier set $C$ in the form of a terniary relation such that it forms a partially commutative monoid.
...
\begin{mathpar}
  ...
  \inferrule
      {\gamma : \PreCtx_n \\
        ...
        t : \Type \\
        \stacked{idx : \Idx \\\\ x \; y \; z : \Carrier_{idx}^2}\\
        \op{x}{y}{z}}
  ...
  \inferrule
      {\gamma : \PreCtx_n \\
        \stacked{idxs : \Idxs_n \\\\ \Gamma : \Ctx_{idxs}}\\
        t \; t' \; : Type \\
        \stacked{idx : \Idx \\\\ x : \Carrier_{idx}^2} \\
        \stacked{idx' : \Idx \\\\ x' : \Carrier_{idx'}^2} \\
        \Delta : \Ctx_{idxs} \\\\

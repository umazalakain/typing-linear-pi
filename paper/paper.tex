...
\begin{example}[Typing derivation]
  ...
  $\func{sync} \; : \; \forall \{n\} \to \Var_n \to \Var_n \to \Var_n \to \Process_n$
  $\func{sync} \; i0 \; i1 \; o \; =$
    $\recv{i0}{} \recv{(\suc \; i1)}{} \send{(\suc \suc \; o)}{\suc \constr{0}} \send{(\suc \suc \; o)}{\constr{0}} \PO$

  $\func{send} \; : \; \forall \{n\} \to \Var_n \to \Process_n$
  $\func{send} \; c \; = \new{} (\send{\suc c}{\constr{0}} \PO)$

  $\func{recv} \; : \; \forall \{n\} \to \Var_n \to \Process_n$
  ...
  $\func{\_} \; : \; \types{\constr{[]}}{\constr{[]}}{\func{example}}{\constr{[]}}$
  $\func{\_} = \new{} \; \channel{\unit}{\omega} \; \lz \; 1$
    $( (\send{\suc \constr{0}}{\constr{0}} \PO)$
    $\comp{}{ \new{} \; \channel{\unit}{\omega} \; \lz \; 1 }$
      $( (\send{\suc \constr{0}}{\constr{0}} \PO)$
      $\comp{}{ \new{} \; \channel{\unit}{\omega} \; \lz \; 2 }$
        $( (\recv{\constr{0}}{} (\recv{\suc \constr{0}}{} \PO))$
        $\comp{}{( ( \recv{\suc (\suc \constr{0}))}{}}$

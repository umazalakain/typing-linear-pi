...
$\func{\vdash PP}$ = $\new \; \channel{\unit}{\func{\omega}} \; \li \; (\suc \suc \constr{0}) \; (\comp{\vdash P}{\vdash P})$
  ...
  Notice that the \emph{only} differences between the definition of the untyped process $\func{P}$ and its typing derivation are the extra type annotations that accompany scope restriction.
  This extra information demands a (limited) choice.

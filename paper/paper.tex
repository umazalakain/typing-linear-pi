...
\begin{abstract}
  ...
  We use leftover typing \cite{Allais2018a} to encode our typing rules, thus avoiding the ubiquitous context splitting proofs, which are mandatory when dealing with linear type systems.

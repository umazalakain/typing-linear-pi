...
Quantifier.Balanced Gradual (x , y) = x ≡ y
Quantifier.Balanced-ℓ∅ Gradual = refl
Quantifier.Balanced-ℓ# Gradual = refl
Quantifier.Balanced-∙ˡ Gradual Bx refl split = ℕₚ.+-cancelʳ-≡ _ _ Bx
Quantifier.Balanced? Gradual (x , y) = x ℕₚ.≟ y

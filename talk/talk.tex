...
\begin{document}
  ...
  \note[itemize]{
    ...
    \item Keep a proof $uQ$ alongside
  }
  ...
  \begin{frame}{Type System}
    \begin{itemize}
      ...
      \item Unidirectional -- scope restriction requires types as input
      \item Uses leftover typing
      \item Based on an indexed set of usage algebras
    \end{itemize}
  \end{frame}
  
  \begin{frame}{Multiplicities and Capabilities}
    \begin{equation*}
    \begin{aligned}
      &\zero                 &:{} &                 &        & C \\
      &\one                  &:{} &                 &        & C \\

...
\begin{document}
  ...
  \note{
    Hello everyone! I am Uma, and this talk is about my first formalisation of a type system (in this case a resource-aware \picalc{}) in Agda.
  ...
  \begin{frame}{Motivation}
    \begin{block}{\picalc{}?}
      ...
      like the \lambdacalc{}, but with $\beta$-reduction \emph{at a distance}
    \end{block}
    \hfill\\
  ...
  \begin{frame}{Usage Algebra}
    \begin{columns}
      \begin{column}{0.3\textwidth}
        \begin{itemize}
          \item partial
          \item neutral element $\zero$
          \item minimal element $\zero$
          \item associative
          \item commutative
          \item deterministic
          \item cancellative

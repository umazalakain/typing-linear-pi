...
\begin{document}
  ...
  \begin{frame}{Initial Pitfalls}
    ...
    \sitem using functions to update usage contexts
      \begin{mathpar}
        \inferrule
        {\ldots \\ \gamma \; \type{;} \; (\func{update}_i \; \ldots \; \Gamma) \vdash P \\ \ldots}
  ...
  \begin{frame}{Subject Reduction}
    \begin{itemize}
      ...
      TODO: substitution, dumbed down
      TODO: substitution, emphasis on easy paper, tricky mechanise

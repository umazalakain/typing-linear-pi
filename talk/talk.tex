...
\begin{document}
  ...
  \begin{frame}{Type System: Initial Pitfalls}
    \begin{itemize}
    \item Using functions on usage contexts
      \begin{mathpar}
      \inferrule
      {\stacked{
  ...
  \begin{frame}{Type System}
    \begin{itemize}
      ...
      \item Type and usage contexts are independent
      \item Leftover usage context
  ...
  \note[itemize]{
  \item First four by induction on \textsc{Types} and \textsc{VarRef}
  }
